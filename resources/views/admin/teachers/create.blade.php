{{-- View: admin.teachers.create | Role: admin | Module: Teachers --}}
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.teachers.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telephone" id="telephone" value="{{ old('telephone') }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300">
                            @error('telephone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        
                        <!-- Document Contractuel -->
                        <div class="mb-4">
                            <label for="document_contractuel" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Document Contractuel (Optionnel, ex: path/to/pdf)</label>
                            <input type="text" name="document_contractuel" id="document_contractuel" value="{{ old('document_contractuel') }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300">
