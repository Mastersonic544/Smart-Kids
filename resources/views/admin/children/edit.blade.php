{{-- View: admin.children.edit | Role: admin | Module: Children --}}

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Modifier un Enfant') }}: {{ $child->prenom }} {{ $child->nom }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.children.update', $child->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nom" id="nom" value="{{ old('nom', $child->nom) }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="prenom" id="prenom" value="{{ old('prenom', $child->prenom) }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $child->date_naissance) }}" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="allergies" id="allergies" rows="3" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300">{{ old('allergies', $child->allergies) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="parent_id" id="parent_id" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300" required>
                                ...
                                @foreach($parents as $parent)
                                    <option value="{{ $parent->id }}" {{ old('parent_id', $child->parent_id) == $parent->id ? 'selected' : '' }}>{{ $parent->name }} ({{ $parent->email }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="classroom_id" id="classroom_id" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-black dark:text-gray-300">
                                ...
                                @foreach($classrooms as $classroom)
                                    <option value="{{ $classroom->id }}" {{ old('classroom_id', $child->classroom_id) == $classroom->id ? 'selected' : '' }}>{{ $classroom->name }}</option>
                                @endforeach
                            </select>
