{{-- View: admin.parents.edit | Role: admin | Module: Parents --}}
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.parents.update', $parent->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $parent->phone) }}" placeholder="Ex: 20123456"
                                   class="mt-1 flex-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600">
                        </div>

                        <div class="mt-8 mb-4 border-t pt-4">
                            <h3 class="font-medium mb-3 text-slate-800 dark:text-slate-100">Changer le mot de passe (optionnel)</h3>
                        </div>
